...
const stringifiedMessages = '[{"submittedBy":"Bob","message":"Hello World!"},{"submittedBy":"Jane","message":"Last Friday I saw a spotted striped blue worm shake hands with a legless lizard."},{"submittedBy":"Jane","message":"On a scale from one to ten, whats your favorite flavor of random grammar?"},{"submittedBy":"Jane","message":"It dawned on her that others could make her happier, but only she could make herself happy."},{"submittedBy":"Jane","message":"Someone I know recently combined Maple Syrup & buttered Popcorn thinking it would taste like caramel popcorn. It didn’t and they don’t recommend anyone else do it either."},{"submittedBy":"Jane","message":"Lets all be unique together until we realise we are all the same."},{"submittedBy":"Jane","message":"Improve your goldfishs physical fitness by getting him a bicycle."}]';
